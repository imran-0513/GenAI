...
def process_documents(uploaded_files):
    ...
    save_processed_documents(text_chunks)
    return text_chunks
...
# Function to save processed documents to a file
def save_processed_documents(text_chunks):
    with open("processed_documents.txt", "w") as f:
        for chunk in text_chunks:
            f.write(chunk + '\n')

# Function to load processed documents from a file
def load_processed_documents():
    text_chunks = []
    if os.path.exists("processed_documents.txt"):
        with open("processed_documents.txt", "r") as f:
...
def admin_interface():
    ...
    text_chunks = load_processed_documents()
